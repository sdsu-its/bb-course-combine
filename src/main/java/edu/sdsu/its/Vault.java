 ...
 * <p>
 * Uses "VAULT_ADDR", "VAULT_ROLE", "VAULT_SECRET", and "BB_CX_APP" environment variables to set the Vault Configuration.
 *
 * @author Tom Paulus
 *         Created on 11/3/16.
 */
public class Vault {
    ...
    final private static String APP_NAME = System.getenv("BB_CX_APP");
